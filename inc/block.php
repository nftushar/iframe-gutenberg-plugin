...
class BDBBlockDirectory{
	...
	function render( $attributes ){
		...
		ob_start(); ?>
		<div class='<?php echo esc_attr( $ifmIframeClassName ); ?>' id='ifmIframe-<?php echo esc_attr( $cId ) ?>' data-attributes='<?php echo esc_attr( wp_json_encode( $attributes ) ); ?>'>
		...
		<div class="ifmIframe">
			...
			<?php echo $isFullScreen ? "<button class='fullScreenBtn'>
